...
type PreviewGalleryProps = {
  ...
  onOpenLightbox: (imageUrl: string, title: string, items: Array<{ imageUrl: string; title: string }>) => void
                ...
                <button
                  ...
                  onClick={() =>
                    selectionMode
                      ...
                      : onOpenLightbox(slot.imageUrl, slot.title, imageItems.map((item) => ({ imageUrl: item.imageUrl, title: item.title })))
                  }
                >
